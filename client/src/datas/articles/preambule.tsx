...
const preambulePara1_1: Paragraphe = {
...
const preambulePara1_2: Paragraphe = {
...
const preambulePara1_3: Paragraphe = {
...
const preambulePara1_6: Paragraphe = {
...
const preambulePara1_7: Paragraphe = {
...
const preambulePara1: Paragraphe = {
  texte: [
    preambulePara1_1,
    preambulePara1_2,
    preambulePara1_3,
...
const preambulePara2_1: Paragraphe = {
  texte: <ul>
...
const preambulePara2_2: Paragraphe = {
  texte: ``,
  tempsDepart: 10,
  dateDerniereModif: new Date(2020, 4, 30),
};
const preambulePara2_3: Paragraphe = {
  texte: ``,
  tempsDepart: 10,
  dateDerniereModif: new Date(2020, 4, 30),
};
const preambulePara2_4: Paragraphe = {
  texte: ``,
  tempsDepart: 10,
  dateDerniereModif: new Date(2020, 4, 30),
};
const preambulePara2_5: Paragraphe = {
  texte: ``,
  tempsDepart: 10,
  dateDerniereModif: new Date(2020, 4, 30),
};
const preambulePara2_6: Paragraphe = {
  texte: ``,
  tempsDepart: 10,
  dateDerniereModif: new Date(2020, 4, 30),
};
const preambulePara2_7: Paragraphe = {
  texte: ``,
  tempsDepart: 10,
  dateDerniereModif: new Date(2020, 4, 30),
};
const preambulePara2_8: Paragraphe = {
  texte: ``,
  tempsDepart: 10,
  dateDerniereModif: new Date(2020, 4, 30),
};
const preambulePara2: Paragraphe = {
  texte: [
    preambulePara2_1,
    preambulePara2_2,
    preambulePara2_3,
