...
const intentionPara1: Paragraphe = {
  texte: <>
...
const intentionPara2_1: Paragraphe = {
  texte: <>
...
const intentionPara2_2: Paragraphe = {
...
const intentionPara2: Paragraphe = {
  texte: [intentionPara2_1, intentionPara2_2],
  tempsDepart: 27.3,
  dateDerniereModif: new Date(2020, 4, 30),
};

const intentionPara3: Paragraphe = {
