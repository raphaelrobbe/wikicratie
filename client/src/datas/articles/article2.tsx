...
const article2Intention: Paragraphe = {
...
const article2Para1: Paragraphe = {
  texte: [
    article2Para1_1,
    article2Para1_2,
  ],
...
const article2Para2: Paragraphe = {
